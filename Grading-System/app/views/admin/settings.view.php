...
<head>
    ...
    <link rel="stylesheet" href="<?= ROOT?>/assets/css/admin/settings.css">
</head>
<body>
...
<div class="header"><h2>Admin Profile</h2></div>

    <section class="content">
        <div class="update">
        <div class="image"><img src="<?= ROOT?>/assets/images/bot.png"></div>
    <div class = "container">
