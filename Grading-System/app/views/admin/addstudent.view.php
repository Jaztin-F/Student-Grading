...
<div class="header"><h2>Add Student</h2></div>
    <section class="content">
    
    <div class="addstudent">
<div class = "container">
<form method="post">
<div class="inputBox"> <input type="text" name="student_id" required><i>Student_ID</i></div>
<div class="studentname">
       ...
       <div class="inputBox"> <input type="text" name="contact_number" required><i>Contact</i></div>
        ...
        <div class="address1">
       <div class="inputBox"> <input type="text" name="purok" required><i>purok</i></div>
       <div class="inputBox"> <input type="text" name="home_address" required><i>home_address</i></div>
       <div class="inputBox"> <input type="text" name="barangay" required><i>barangay</i></div>
        </div>  
       
       <div class="address2">
       <div class="inputBox"> <input type="text" name="municipality" required><i>municipality</i></div>
       <div class="inputBox"> <input type="text" name="province" required><i>province</i></div>
       <div class="inputBox"> <input type="text" name="zip_code" required><i>zip_code</i></div>
        </div>  
        ...
        <select name="institute"required>
            ...
            <div class="guardian">
            <div class="inputBox"> <input type="text" name="emergency_contact_name" required><i>Guardian Name</i></div>
            <div class="inputBox"> <input type="text" name="emergency_contact_number" required><i>Guardian Contact</i></div>
            </div>

            <div class="inputBox"> <input class= "guardianaddress"type="text" name="emergency_contact_address" required><i>Guardian Address</i></div>
            <div class="inputBox"> <input type="text" name="password" value="grade2023" hidden></div>
        <div class="inputBox"><input type="submit" value="Add Student"></div></form></div>
        </form>
    </div></div>
    </section>
</body>
