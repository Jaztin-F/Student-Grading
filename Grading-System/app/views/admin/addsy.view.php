...
<div class="header"><h2>Add School Year</h2></div>

    <section class="content">
    <div class="schoolyear">
<div class = "container">
<form method="post">
<div class="inputBox"> <input type="text" name="isActive" value="Inactive" hidden></div>
    <div class="info">
            <div class="inputBox"> <input type="text" name="school_year" required><i>School Year</i></div>
        ...
        <div class="inputBox"><input type="submit" value="Add School Year"></div></form></div>
